...
//
//  Created by piaojin on 2020/12/30.
//
...
#import "WebRTCVirtualBackgroundPOC-Swift.h"
...
- (void) setShouldShowVBGPreview: (BOOL) shouldShow {
    _shouldShowVBGPreview = shouldShow;
    if (_shouldShowVBGPreview) {
        [self showBeautyEditView];
    } else {
        [self dismissBeautyEditView];
    }
}
